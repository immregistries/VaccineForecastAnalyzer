...
public class PersonalDetailsPage extends FTBasePage implements SecurePage {
  ...
  public PersonalDetailsPage(final PageParameters pageParameters) {
    ...
    add(new Label("position", user.getPosition()));
