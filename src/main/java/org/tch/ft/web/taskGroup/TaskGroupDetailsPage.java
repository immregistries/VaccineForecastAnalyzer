...
public class TaskGroupDetailsPage extends FTBasePage implements SecurePage {
  private static final long serialVersionUID = 1L;

  public TaskGroupDetailsPage() {
    this(new PageParameters());
  }

  public TaskGroupDetailsPage(final PageParameters pageParameters) {
