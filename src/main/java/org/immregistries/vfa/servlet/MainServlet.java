...
import org.immregistries.vfa.connect.SoftwareVersion;
...
public abstract class MainServlet extends HttpServlet
{
  ...
  public void printPage(HttpServletRequest req, HttpServletResponse resp, String show) throws IOException {
    if (show == null || !show.equals(SHOW_NOTHING)) {
      ...
      try {
        ...
        out.println("<p>The Vaccine Forecast Analyzer has encountered an unexpected problem and is unable to proccess your "
  ...
  public void printHeader(PrintWriter out) {
    out.println("<html>");
    out.println("  <head>");
    out.println("    <title>Vaccine Forecast Analyzer - " + title + "</title>");
    ...
    if (user != null && user.isLoggedIn()) {
      ...
      out.println("    <h1>Vaccine Forecast Analyzer</h1>");
    }
  ...
  public void printFooter(PrintWriter out) {
    out.println("    </div>");
    out.println("   <br/><span class=\"version\">Vaccine Forecast Analyzer version " + org.immregistries.vfa.SoftwareVersion.VERSION
        + "</span>");
    out.println("  </body>");
    out.println("</html>");
  }
