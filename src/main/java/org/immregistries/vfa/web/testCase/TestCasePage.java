...
public class TestCasePage extends FTBasePage implements SecurePage {
  ...
  public TestCasePage(final PageParameters pageParameters) {
    ...
    selected.setVisible(testCase != null);
    selected.add(new Label("testCaseLabel", testCase != null ? testCase.getLabel() : ""));
