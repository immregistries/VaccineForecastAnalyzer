...
public class TestCaseCentralPage extends TestCaseDetail implements SecurePage
{
  ...
  public TestCaseCentralPage() {
    this(new PageParameters());
  }

  public TestCaseCentralPage(final PageParameters pageParameters) {
    ...
    ExternalLink forecastLink = new ExternalLink("forecastLink", "http://tchforecasttester.org/fv/forecast"
        + LSVFConnector.createQueryString(testCase, software, "html"));
    add(forecastLink);
    ExternalLink stepLink = new ExternalLink("stepLink", "http://tchforecasttester.org/fv/fv/step"
        + LSVFConnector.createQueryString(testCase, software, "text"));
    add(stepLink);
