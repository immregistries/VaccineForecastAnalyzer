...
public class TestICEConnector extends junit.framework.TestCase {
  ...
  public void testForecast() throws Exception {
    ...
    TestCase testCase = createTestCase(session, sdf);

    Software software = new Software();
    software.setServiceUrl("http://localhost:8086/o/evaluate");
    Query query = session.createQuery("from ForecastItem");
  ...
  public TestCase createTestCase(Session session, SimpleDateFormat sdf) throws ParseException {
    ...
    testCase.setTestEventList(testEventList);
    {
      ...
      testEvent.setEvent((Event) session.get(Event.class, 45));
    ...
    {
      TestEvent testEvent = new TestEvent();
      testEvent.setEvent((Event) session.get(Event.class, 8));
